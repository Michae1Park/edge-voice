#!/bin/bash
# Resume run: p1_baseline, p1_density_95, p1_density_97, p1_rate_1.5,
# p1_rate_2.0 already completed successfully (verdicts.txt has all 5,
# results not touched). Runs only the remaining 6 cells with the corrected
# names (p1_length_7/p1_length_10, not the stale p1_length_9/p1_length_15).
set -uo pipefail
cd /home/ai/workspace/edge-voice
source venv/bin/activate
mkdir -p characterization/results/boundary

declare -A RATE=( [p1_length_7]=1.0 [p1_length_10]=1.0 [p2_a]=2.0 [p2_b_max]=2.0 [p2_c]=1.0 [p2_d]=2.0 )

CELLS="p1_length_7 p1_length_10 p2_a p2_b_max p2_c p2_d"
